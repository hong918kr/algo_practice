...
class TestProgram(unittest.TestCase):
	...
	def test_case_3(self):
		...
		linkedList.setHead(first)
		self.assertEqual(linkedList.containNodeWithValue(1), True)
		linkedList.insertAfter(first,second)
		self.assertEqual(linkedList.containNodeWithValue(2), True)
		linkedList.insertAfter(second,third)
		self.assertEqual(linkedList.containNodeWithValue(3), True)
		linkedList.insertAfter(third,fourth)
		self.assertEqual(linkedList.containNodeWithValue(4), True)
		linkedList.removeNodesWithValue(3)
		self.assertEqual(linkedList.containNodeWithValue(3), False)
		linkedList.remove(first)
		self.assertEqual(linkedList.containNodeWithValue(1), False)
		linkedList.removeNodesWithValue(4)
		self.assertEqual(linkedList.containNodeWithValue(4), False)
		linkedList.remove(second)
		self.assertEqual(linkedList.containNodeWithValue(2), False)
